                               ...
                               int8_t numBands, uint8_t type1, float min1, float max1, uint8_t type2, float min2, float max2, uint8_t type3, float min3, float max3, uint8_t type4, float min4, float max4, uint8_t type5, float min5, float max5)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_ICAROUS_KINEMATIC_BANDS_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_ICAROUS_KINEMATIC_BANDS_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_icarous_kinematic_bands_t* icarous_kinematic_bands_final = (mavlink_icarous_kinematic_bands_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), icarous_kinematic_bands_final, MAVLINK_MSG_ID_ICAROUS_KINEMATIC_BANDS_LEN);
...
static inline void mavlink_msg_icarous_kinematic_bands_decode(const mavlink_message_t* msg, mavlink_icarous_kinematic_bands_t* icarous_kinematic_bands)
{
   ...
   // };
    ...
    memcpy(icarous_kinematic_bands, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(icarous_kinematic_bands, decrypt_char, len);
