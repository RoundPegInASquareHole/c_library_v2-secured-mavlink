                               ...
                               uint8_t status)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_ICAROUS_HEARTBEAT_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_ICAROUS_HEARTBEAT_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_icarous_heartbeat_t* icarous_heartbeat_final = (mavlink_icarous_heartbeat_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), icarous_heartbeat_final, MAVLINK_MSG_ID_ICAROUS_HEARTBEAT_LEN);
...
static inline void mavlink_msg_icarous_heartbeat_decode(const mavlink_message_t* msg, mavlink_icarous_heartbeat_t* icarous_heartbeat)
{
   ...
   // };
    ...
    memcpy(icarous_heartbeat, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(icarous_heartbeat, decrypt_char, len);
