                               ...
                               uint8_t target_system, uint8_t target_component, uint32_t format, const char *tune)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_PLAY_TUNE_V2_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_PLAY_TUNE_V2_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_play_tune_v2_t* play_tune_v2_final = (mavlink_play_tune_v2_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), play_tune_v2_final, MAVLINK_MSG_ID_PLAY_TUNE_V2_LEN);
...
static inline void mavlink_msg_play_tune_v2_decode(const mavlink_message_t* msg, mavlink_play_tune_v2_t* play_tune_v2)
{
   ...
   // };
    ...
    memcpy(play_tune_v2, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(play_tune_v2, decrypt_char, len);
