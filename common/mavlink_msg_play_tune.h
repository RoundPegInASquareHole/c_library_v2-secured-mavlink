                               ...
                               uint8_t target_system, uint8_t target_component, const char *tune, const char *tune2)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_PLAY_TUNE_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_PLAY_TUNE_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_play_tune_t* play_tune_final = (mavlink_play_tune_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), play_tune_final, MAVLINK_MSG_ID_PLAY_TUNE_LEN);
...
static inline void mavlink_msg_play_tune_decode(const mavlink_message_t* msg, mavlink_play_tune_t* play_tune)
{
   ...
   // };
    ...
    memcpy(play_tune, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(play_tune, decrypt_char, len);
