                               ...
                               uint64_t time_usec, const char *name, uint16_t array_id, const float *data)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_debug_float_array_t* debug_float_array_final = (mavlink_debug_float_array_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), debug_float_array_final, MAVLINK_MSG_ID_DEBUG_FLOAT_ARRAY_LEN);
...
static inline void mavlink_msg_debug_float_array_decode(const mavlink_message_t* msg, mavlink_debug_float_array_t* debug_float_array)
{
   ...
   // };
    ...
    memcpy(debug_float_array, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(debug_float_array, decrypt_char, len);
