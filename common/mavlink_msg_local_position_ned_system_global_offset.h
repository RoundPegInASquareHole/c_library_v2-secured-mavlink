                               ...
                               uint32_t time_boot_ms, float x, float y, float z, float roll, float pitch, float yaw)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_local_position_ned_system_global_offset_t* local_position_ned_system_global_offset_final = (mavlink_local_position_ned_system_global_offset_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), local_position_ned_system_global_offset_final, MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_LEN);
...
static inline void mavlink_msg_local_position_ned_system_global_offset_decode(const mavlink_message_t* msg, mavlink_local_position_ned_system_global_offset_t* local_position_ned_system_global_offset)
{
   ...
   // };
    ...
    memcpy(local_position_ned_system_global_offset, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(local_position_ned_system_global_offset, decrypt_char, len);
