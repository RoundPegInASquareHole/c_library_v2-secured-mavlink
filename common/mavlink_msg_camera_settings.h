                               ...
                               uint32_t time_boot_ms, uint8_t mode_id, float zoomLevel, float focusLevel)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_camera_settings_t* camera_settings_final = (mavlink_camera_settings_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), camera_settings_final, MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN);
...
static inline void mavlink_msg_camera_settings_decode(const mavlink_message_t* msg, mavlink_camera_settings_t* camera_settings)
{
   ...
   // };
    ...
    memcpy(camera_settings, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(camera_settings, decrypt_char, len);
