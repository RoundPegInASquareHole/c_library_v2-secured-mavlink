                               ...
                               uint8_t target_system, uint8_t target_component, uint8_t len, const uint8_t *data)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_GPS_INJECT_DATA_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_GPS_INJECT_DATA_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_gps_inject_data_t* gps_inject_data_final = (mavlink_gps_inject_data_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), gps_inject_data_final, MAVLINK_MSG_ID_GPS_INJECT_DATA_LEN);
...
static inline void mavlink_msg_gps_inject_data_decode(const mavlink_message_t* msg, mavlink_gps_inject_data_t* gps_inject_data)
{
   ...
   // };
    ...
    memcpy(gps_inject_data, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(gps_inject_data, decrypt_char, len);
