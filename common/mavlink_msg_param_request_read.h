                               ...
                               uint8_t target_system, uint8_t target_component, const char *param_id, int16_t param_index)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_param_request_read_t* param_request_read_final = (mavlink_param_request_read_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), param_request_read_final, MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN);
...
static inline void mavlink_msg_param_request_read_decode(const mavlink_message_t* msg, mavlink_param_request_read_t* param_request_read)
{
   ...
   // };
    ...
    memcpy(param_request_read, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(param_request_read, decrypt_char, len);
