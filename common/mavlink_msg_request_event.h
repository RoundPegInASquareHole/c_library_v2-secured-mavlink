                               ...
                               uint8_t target_system, uint8_t target_component, uint16_t first_sequence, uint16_t last_sequence)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_REQUEST_EVENT_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_REQUEST_EVENT_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_request_event_t* request_event_final = (mavlink_request_event_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), request_event_final, MAVLINK_MSG_ID_REQUEST_EVENT_LEN);
...
static inline void mavlink_msg_request_event_decode(const mavlink_message_t* msg, mavlink_request_event_t* request_event)
{
   ...
   // };
    ...
    memcpy(request_event, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(request_event, decrypt_char, len);
