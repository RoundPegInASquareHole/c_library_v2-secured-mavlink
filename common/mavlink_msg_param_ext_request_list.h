                               ...
                               uint8_t target_system, uint8_t target_component)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_param_ext_request_list_t* param_ext_request_list_final = (mavlink_param_ext_request_list_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), param_ext_request_list_final, MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_LEN);
...
static inline void mavlink_msg_param_ext_request_list_decode(const mavlink_message_t* msg, mavlink_param_ext_request_list_t* param_ext_request_list)
{
   ...
   // };
    ...
    memcpy(param_ext_request_list, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(param_ext_request_list, decrypt_char, len);
