                               ...
                               uint8_t target_network, uint8_t target_system, uint8_t target_component, uint16_t message_type, const uint8_t *payload)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_V2_EXTENSION_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_V2_EXTENSION_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_v2_extension_t* v2_extension_final = (mavlink_v2_extension_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), v2_extension_final, MAVLINK_MSG_ID_V2_EXTENSION_LEN);
...
static inline void mavlink_msg_v2_extension_decode(const mavlink_message_t* msg, mavlink_v2_extension_t* v2_extension)
{
   ...
   // };
    ...
    memcpy(v2_extension, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(v2_extension, decrypt_char, len);
