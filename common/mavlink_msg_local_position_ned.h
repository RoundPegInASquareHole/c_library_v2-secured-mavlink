                               ...
                               uint32_t time_boot_ms, float x, float y, float z, float vx, float vy, float vz)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_LOCAL_POSITION_NED_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_LOCAL_POSITION_NED_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_local_position_ned_t* local_position_ned_final = (mavlink_local_position_ned_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), local_position_ned_final, MAVLINK_MSG_ID_LOCAL_POSITION_NED_LEN);
...
static inline void mavlink_msg_local_position_ned_decode(const mavlink_message_t* msg, mavlink_local_position_ned_t* local_position_ned)
{
   ...
   // };
    ...
    memcpy(local_position_ned, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(local_position_ned, decrypt_char, len);
