                               ...
                               uint32_t time_boot_ms, const char *name, float value)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_named_value_float_t* named_value_float_final = (mavlink_named_value_float_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), named_value_float_final, MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_LEN);
...
static inline void mavlink_msg_named_value_float_decode(const mavlink_message_t* msg, mavlink_named_value_float_t* named_value_float)
{
   ...
   // };
    ...
    memcpy(named_value_float, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(named_value_float, decrypt_char, len);
