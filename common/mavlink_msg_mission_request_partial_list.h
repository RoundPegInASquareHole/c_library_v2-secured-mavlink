                               ...
                               uint8_t target_system, uint8_t target_component, int16_t start_index, int16_t end_index, uint8_t mission_type)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_MISSION_REQUEST_PARTIAL_LIST_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_MISSION_REQUEST_PARTIAL_LIST_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_mission_request_partial_list_t* mission_request_partial_list_final = (mavlink_mission_request_partial_list_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), mission_request_partial_list_final, MAVLINK_MSG_ID_MISSION_REQUEST_PARTIAL_LIST_LEN);
...
static inline void mavlink_msg_mission_request_partial_list_decode(const mavlink_message_t* msg, mavlink_mission_request_partial_list_t* mission_request_partial_list)
{
   ...
   // };
    ...
    memcpy(mission_request_partial_list, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(mission_request_partial_list, decrypt_char, len);
