                               ...
                               uint64_t time_usec, const float *controls, uint8_t mode, uint64_t flags)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_hil_actuator_controls_t* hil_actuator_controls_final = (mavlink_hil_actuator_controls_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), hil_actuator_controls_final, MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_LEN);
...
static inline void mavlink_msg_hil_actuator_controls_decode(const mavlink_message_t* msg, mavlink_hil_actuator_controls_t* hil_actuator_controls)
{
   ...
   // };
    ...
    memcpy(hil_actuator_controls, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(hil_actuator_controls, decrypt_char, len);
