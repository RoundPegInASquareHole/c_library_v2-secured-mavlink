                               ...
                               const char *name, uint64_t time_usec, float x, float y, float z)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_DEBUG_VECT_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_DEBUG_VECT_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_debug_vect_t* debug_vect_final = (mavlink_debug_vect_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), debug_vect_final, MAVLINK_MSG_ID_DEBUG_VECT_LEN);
...
static inline void mavlink_msg_debug_vect_decode(const mavlink_message_t* msg, mavlink_debug_vect_t* debug_vect)
{
   ...
   // };
    ...
    memcpy(debug_vect, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(debug_vect, decrypt_char, len);
