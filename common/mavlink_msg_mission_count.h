                               ...
                               uint8_t target_system, uint8_t target_component, uint16_t count, uint8_t mission_type)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_MISSION_COUNT_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_MISSION_COUNT_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_mission_count_t* mission_count_final = (mavlink_mission_count_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), mission_count_final, MAVLINK_MSG_ID_MISSION_COUNT_LEN);
...
static inline void mavlink_msg_mission_count_decode(const mavlink_message_t* msg, mavlink_mission_count_t* mission_count)
{
   ...
   // };
    ...
    memcpy(mission_count, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(mission_count, decrypt_char, len);
