                               ...
                               uint64_t time_usec, const float *q, float x, float y, float z, const float *covariance)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_att_pos_mocap_t* att_pos_mocap_final = (mavlink_att_pos_mocap_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), att_pos_mocap_final, MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN);
...
static inline void mavlink_msg_att_pos_mocap_decode(const mavlink_message_t* msg, mavlink_att_pos_mocap_t* att_pos_mocap)
{
   ...
   // };
    ...
    memcpy(att_pos_mocap, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(att_pos_mocap, decrypt_char, len);
