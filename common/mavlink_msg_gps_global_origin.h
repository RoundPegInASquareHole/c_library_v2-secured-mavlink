                               ...
                               int32_t latitude, int32_t longitude, int32_t altitude, uint64_t time_usec)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_gps_global_origin_t* gps_global_origin_final = (mavlink_gps_global_origin_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), gps_global_origin_final, MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN_LEN);
...
static inline void mavlink_msg_gps_global_origin_decode(const mavlink_message_t* msg, mavlink_gps_global_origin_t* gps_global_origin)
{
   ...
   // };
    ...
    memcpy(gps_global_origin, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(gps_global_origin, decrypt_char, len);
