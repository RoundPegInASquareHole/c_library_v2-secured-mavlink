                               ...
                               uint64_t time_usec, uint32_t seq)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_CAMERA_TRIGGER_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_CAMERA_TRIGGER_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_camera_trigger_t* camera_trigger_final = (mavlink_camera_trigger_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), camera_trigger_final, MAVLINK_MSG_ID_CAMERA_TRIGGER_LEN);
...
static inline void mavlink_msg_camera_trigger_decode(const mavlink_message_t* msg, mavlink_camera_trigger_t* camera_trigger)
{
   ...
   // };
    ...
    memcpy(camera_trigger, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(camera_trigger, decrypt_char, len);
