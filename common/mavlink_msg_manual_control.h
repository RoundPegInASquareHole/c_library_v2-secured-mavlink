                               ...
                               uint8_t target, int16_t x, int16_t y, int16_t z, int16_t r, uint16_t buttons, uint16_t buttons2, uint8_t enabled_extensions, int16_t s, int16_t t)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_MANUAL_CONTROL_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_MANUAL_CONTROL_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_manual_control_t* manual_control_final = (mavlink_manual_control_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), manual_control_final, MAVLINK_MSG_ID_MANUAL_CONTROL_LEN);
...
static inline void mavlink_msg_manual_control_decode(const mavlink_message_t* msg, mavlink_manual_control_t* manual_control)
{
   ...
   // };
    ...
    memcpy(manual_control, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(manual_control, decrypt_char, len);
