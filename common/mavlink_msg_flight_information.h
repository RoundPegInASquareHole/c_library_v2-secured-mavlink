                               ...
                               uint32_t time_boot_ms, uint64_t arming_time_utc, uint64_t takeoff_time_utc, uint64_t flight_uuid)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_FLIGHT_INFORMATION_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_FLIGHT_INFORMATION_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_flight_information_t* flight_information_final = (mavlink_flight_information_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), flight_information_final, MAVLINK_MSG_ID_FLIGHT_INFORMATION_LEN);
...
static inline void mavlink_msg_flight_information_decode(const mavlink_message_t* msg, mavlink_flight_information_t* flight_information)
{
   ...
   // };
    ...
    memcpy(flight_information, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(flight_information, decrypt_char, len);
