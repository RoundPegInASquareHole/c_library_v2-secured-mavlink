                               ...
                               uint64_t time_usec, uint32_t active, const float *actuator)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_ACTUATOR_OUTPUT_STATUS_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_ACTUATOR_OUTPUT_STATUS_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_actuator_output_status_t* actuator_output_status_final = (mavlink_actuator_output_status_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), actuator_output_status_final, MAVLINK_MSG_ID_ACTUATOR_OUTPUT_STATUS_LEN);
...
static inline void mavlink_msg_actuator_output_status_decode(const mavlink_message_t* msg, mavlink_actuator_output_status_t* actuator_output_status)
{
   ...
   // };
    ...
    memcpy(actuator_output_status, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(actuator_output_status, decrypt_char, len);
