                               ...
                               const char *ssid, const char *password, int8_t mode, int8_t response)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_wifi_config_ap_t* wifi_config_ap_final = (mavlink_wifi_config_ap_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), wifi_config_ap_final, MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN);
...
static inline void mavlink_msg_wifi_config_ap_decode(const mavlink_message_t* msg, mavlink_wifi_config_ap_t* wifi_config_ap)
{
   ...
   // };
    ...
    memcpy(wifi_config_ap, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(wifi_config_ap, decrypt_char, len);
