                               ...
                               uint8_t target_system, uint8_t target_component, uint8_t mission_type)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_MISSION_CLEAR_ALL_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_MISSION_CLEAR_ALL_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_mission_clear_all_t* mission_clear_all_final = (mavlink_mission_clear_all_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), mission_clear_all_final, MAVLINK_MSG_ID_MISSION_CLEAR_ALL_LEN);
...
static inline void mavlink_msg_mission_clear_all_decode(const mavlink_message_t* msg, mavlink_mission_clear_all_t* mission_clear_all)
{
   ...
   // };
    ...
    memcpy(mission_clear_all, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(mission_clear_all, decrypt_char, len);
