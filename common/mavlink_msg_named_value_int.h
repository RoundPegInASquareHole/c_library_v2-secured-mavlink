                               ...
                               uint32_t time_boot_ms, const char *name, int32_t value)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_named_value_int_t* named_value_int_final = (mavlink_named_value_int_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), named_value_int_final, MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN);
...
static inline void mavlink_msg_named_value_int_decode(const mavlink_message_t* msg, mavlink_named_value_int_t* named_value_int)
{
   ...
   // };
    ...
    memcpy(named_value_int, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(named_value_int, decrypt_char, len);
