                               ...
                               uint64_t time_usec, int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro, int16_t xmag, int16_t ymag, int16_t zmag, uint8_t id, int16_t temperature)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_RAW_IMU_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_RAW_IMU_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_raw_imu_t* raw_imu_final = (mavlink_raw_imu_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), raw_imu_final, MAVLINK_MSG_ID_RAW_IMU_LEN);
...
static inline void mavlink_msg_raw_imu_decode(const mavlink_message_t* msg, mavlink_raw_imu_t* raw_imu)
{
   ...
   // };
    ...
    memcpy(raw_imu, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(raw_imu, decrypt_char, len);
