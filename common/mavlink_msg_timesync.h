                               ...
                               int64_t tc1, int64_t ts1)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_TIMESYNC_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_TIMESYNC_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_timesync_t* timesync_final = (mavlink_timesync_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), timesync_final, MAVLINK_MSG_ID_TIMESYNC_LEN);
...
static inline void mavlink_msg_timesync_decode(const mavlink_message_t* msg, mavlink_timesync_t* timesync)
{
   ...
   // };
    ...
    memcpy(timesync, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(timesync, decrypt_char, len);
