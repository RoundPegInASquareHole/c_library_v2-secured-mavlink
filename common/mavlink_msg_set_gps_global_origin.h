                               ...
                               uint8_t target_system, int32_t latitude, int32_t longitude, int32_t altitude, uint64_t time_usec)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_set_gps_global_origin_t* set_gps_global_origin_final = (mavlink_set_gps_global_origin_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), set_gps_global_origin_final, MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN_LEN);
...
static inline void mavlink_msg_set_gps_global_origin_decode(const mavlink_message_t* msg, mavlink_set_gps_global_origin_t* set_gps_global_origin)
{
   ...
   // };
    ...
    memcpy(set_gps_global_origin, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(set_gps_global_origin, decrypt_char, len);
