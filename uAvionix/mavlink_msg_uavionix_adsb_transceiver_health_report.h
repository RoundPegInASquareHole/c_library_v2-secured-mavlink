                               ...
                               uint8_t rfHealth)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_uavionix_adsb_transceiver_health_report_t* uavionix_adsb_transceiver_health_report_final = (mavlink_uavionix_adsb_transceiver_health_report_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), uavionix_adsb_transceiver_health_report_final, MAVLINK_MSG_ID_UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT_LEN);
...
static inline void mavlink_msg_uavionix_adsb_transceiver_health_report_decode(const mavlink_message_t* msg, mavlink_uavionix_adsb_transceiver_health_report_t* uavionix_adsb_transceiver_health_report)
{
   ...
   // };
    ...
    memcpy(uavionix_adsb_transceiver_health_report, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(uavionix_adsb_transceiver_health_report, decrypt_char, len);
