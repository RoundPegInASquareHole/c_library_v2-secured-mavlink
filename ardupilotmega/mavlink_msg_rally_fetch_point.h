                               ...
                               uint8_t target_system, uint8_t target_component, uint8_t idx)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_RALLY_FETCH_POINT_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_RALLY_FETCH_POINT_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_rally_fetch_point_t* rally_fetch_point_final = (mavlink_rally_fetch_point_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), rally_fetch_point_final, MAVLINK_MSG_ID_RALLY_FETCH_POINT_LEN);
...
static inline void mavlink_msg_rally_fetch_point_decode(const mavlink_message_t* msg, mavlink_rally_fetch_point_t* rally_fetch_point)
{
   ...
   // };
    ...
    memcpy(rally_fetch_point, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(rally_fetch_point, decrypt_char, len);
