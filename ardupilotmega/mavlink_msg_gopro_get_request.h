                               ...
                               uint8_t target_system, uint8_t target_component, uint8_t cmd_id)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_GOPRO_GET_REQUEST_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_GOPRO_GET_REQUEST_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_gopro_get_request_t* gopro_get_request_final = (mavlink_gopro_get_request_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), gopro_get_request_final, MAVLINK_MSG_ID_GOPRO_GET_REQUEST_LEN);
...
static inline void mavlink_msg_gopro_get_request_decode(const mavlink_message_t* msg, mavlink_gopro_get_request_t* gopro_get_request)
{
   ...
   // };
    ...
    memcpy(gopro_get_request, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(gopro_get_request, decrypt_char, len);
