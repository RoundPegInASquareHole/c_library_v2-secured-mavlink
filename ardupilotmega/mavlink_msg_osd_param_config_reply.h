                               ...
                               uint32_t request_id, uint8_t result)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_OSD_PARAM_CONFIG_REPLY_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_OSD_PARAM_CONFIG_REPLY_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_osd_param_config_reply_t* osd_param_config_reply_final = (mavlink_osd_param_config_reply_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), osd_param_config_reply_final, MAVLINK_MSG_ID_OSD_PARAM_CONFIG_REPLY_LEN);
...
static inline void mavlink_msg_osd_param_config_reply_decode(const mavlink_message_t* msg, mavlink_osd_param_config_reply_t* osd_param_config_reply)
{
   ...
   // };
    ...
    memcpy(osd_param_config_reply, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(osd_param_config_reply, decrypt_char, len);
