                               ...
                               uint8_t target_system, uint8_t target_component, int16_t rl_torque_cmd, int16_t el_torque_cmd, int16_t az_torque_cmd)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_GIMBAL_TORQUE_CMD_REPORT_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_GIMBAL_TORQUE_CMD_REPORT_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_gimbal_torque_cmd_report_t* gimbal_torque_cmd_report_final = (mavlink_gimbal_torque_cmd_report_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), gimbal_torque_cmd_report_final, MAVLINK_MSG_ID_GIMBAL_TORQUE_CMD_REPORT_LEN);
...
static inline void mavlink_msg_gimbal_torque_cmd_report_decode(const mavlink_message_t* msg, mavlink_gimbal_torque_cmd_report_t* gimbal_torque_cmd_report)
{
   ...
   // };
    ...
    memcpy(gimbal_torque_cmd_report, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(gimbal_torque_cmd_report, decrypt_char, len);
