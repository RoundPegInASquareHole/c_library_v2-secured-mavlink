                               ...
                               const uint8_t *temperature, const uint16_t *voltage, const uint16_t *current, const uint16_t *totalcurrent, const uint16_t *rpm, const uint16_t *count)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_ESC_TELEMETRY_9_TO_12_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_ESC_TELEMETRY_9_TO_12_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_esc_telemetry_9_to_12_t* esc_telemetry_9_to_12_final = (mavlink_esc_telemetry_9_to_12_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), esc_telemetry_9_to_12_final, MAVLINK_MSG_ID_ESC_TELEMETRY_9_TO_12_LEN);
...
static inline void mavlink_msg_esc_telemetry_9_to_12_decode(const mavlink_message_t* msg, mavlink_esc_telemetry_9_to_12_t* esc_telemetry_9_to_12)
{
   ...
   // };
    ...
    memcpy(esc_telemetry_9_to_12, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(esc_telemetry_9_to_12, decrypt_char, len);
