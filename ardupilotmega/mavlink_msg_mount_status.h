                               ...
                               uint8_t target_system, uint8_t target_component, int32_t pointing_a, int32_t pointing_b, int32_t pointing_c)
{
    ...
    uint8_t encrypt[MAVLINK_MSG_ID_MOUNT_STATUS_LEN];
    ChaCha20XOR(chacha20_key, 1, nonce, (uint8_t *)packet_char, (uint8_t *)encrypt, MAVLINK_MSG_ID_MOUNT_STATUS_LEN);
    const char* encrypt_char = (const char*) &encrypt;
    
    mavlink_mount_status_t* mount_status_final = (mavlink_mount_status_t*)encrypt_char;
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), mount_status_final, MAVLINK_MSG_ID_MOUNT_STATUS_LEN);
...
static inline void mavlink_msg_mount_status_decode(const mavlink_message_t* msg, mavlink_mount_status_t* mount_status)
{
   ...
   // };
    ...
    memcpy(mount_status, _MAV_PAYLOAD(msg), len); // this is the original way to decode the incomming payload
    ...
    //memcpy(mount_status, decrypt_char, len);
